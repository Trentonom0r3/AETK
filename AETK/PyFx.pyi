...
class StreamValue2Ptr(AEHandle):
...
class StreamSuite:
    ...
    def GetNewStreamValue(self, stream: StreamRefPtr, timeMode: LTimeMode, time: Time, preExpression: bool) -> StreamValue2Ptr:
        pass
    
    def SetStreamValue(self, stream: StreamRefPtr, value: StreamValue2Ptr):
        pass
...
class KeyframeSuite:
    ...
    def GetNewKeyframeValue(self, stream: StreamRefPtr, keyIndex: int) -> StreamValue2Ptr:
        pass
    
    def SetKeyframeValue(self, stream: StreamRefPtr, keyIndex: int, value: StreamValue2Ptr):
        pass
    ...
    def GetNewKeyframeSpatialTangents(self, stream: StreamRefPtr, keyIndex: int) -> Tuple[StreamValue2Ptr, StreamValue2Ptr]:
        pass
    
    def SetKeyframeSpatialTangents(self, stream: StreamRefPtr, keyIndex: int, inTan: StreamValue2Ptr, outTan: StreamValue2Ptr):
        pass
    ...
    def SetAddKeyframe(self, akH: AddKeyframesInfoPtr, keyIndex: int, value: StreamValue2Ptr):
        pass
