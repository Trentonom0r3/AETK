...
template <typename T> class Collection
{
  public:
     ...
     */
    Collection(std::vector<T> collection) : m_collection(collection) {}
     ...
     */
    std::vector<T> GetCollection() { return m_collection; }
    ...
    {
        m_collection.insert(m_collection.end(), items.begin(), items.end());
    }
    ...
    virtual size_t index(T item)
    {
        return std::distance(
            m_collection.begin(),
            std::find(m_collection.begin(), m_collection.end(), item));
    }
    ...
    {
        return std::find(m_collection.begin(), m_collection.end(), item) !=
               m_collection.end();
    }
     ...
     */
    virtual std::vector<T> copy() { return m_collection; }
    ...
    {
        return std::vector<T>(m_collection.begin() + start,
    ...
    {
        return std::vector<T>(m_collection.begin() + start, m_collection.end());
    }
     ...
     * \return std::vector<T> A slice of the collection.
     */
    virtual std::vector<T> slice() { return m_collection; }
  ...
  protected:
    std::vector<T> m_collection; /**< The collection of items. */
};
